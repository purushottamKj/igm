      ...
      message: {
        issue: {
          ...
          order_details: {
            ...
            merchan_torder__id: fulfillments_merchan_torder__id,
          },
          description: {
            short_desc,
            long_desc,
          ...
          finalized_odr: {
            name: finalized_odr_name,
            about_info: about_info,
            url: finalized_url,
            organization: {
              org: {
                name: finalized_org_name,
              },
              contact: {
                name: finalized_org_contact_name,
                phone: finalized_org_contact_phone,
                email: finalized_org_contact_email,
              },
              person: {
                name: finalized_org_person_name,
              },
            },
            pricing_model: {
              price: {
                currency: finalized_org_currency,
                value: finalized_org_value,
              },
              pricing_info: finalized_pricing_info,
            },
            resolution_ratings: {
          ...
          additional_info_required: [
            {
              info_provided: {
                description: {
                  short_desc: additional_info_required_short_desc,
                  long_desc: additional_info_required_long_desc,
                  images: additional_info_required_images,
                },
                updated_at: additional_info_updated_at,
                message_id: additional_info_required_message_id,
              },
            },
          ],
        },
...
export const getIssue = async (req, res) => {
  ...
  // const issue = data.context.transaction_id;
  const context = JSON.parse(data[1].context);
  console.log(context.transaction_id);
